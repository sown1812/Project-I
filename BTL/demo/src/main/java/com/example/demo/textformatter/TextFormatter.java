...
public class TextFormatter {
    ...
    public ObservableList<app.textformatter.KeywordEntry> createKeywordEntries(Map<String, Set<Integer>> keywordIndex) {
        ObservableList<app.textformatter.KeywordEntry> keywordEntries = FXCollections.observableArrayList();
